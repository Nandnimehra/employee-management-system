...
logo=CTkImage(Image.open('imagee.jpg'),size=(930,150))
...
idEntry=CTkEntry(leftFrame,font=('arial',15,'bold'),fg_color='white',width=180,text_color='black')
idEntry.grid(row=0,column=1)

nameLabel=CTkLabel(leftFrame,text='Name',font=('arial',18,'bold'))
nameLabel.grid(row=1,column=0,padx=20,pady=15,sticky='w')

nameEntry=CTkEntry(leftFrame,font=('arial',15,'bold'),fg_color='white',width=180,text_color='black')
nameEntry.grid(row=1,column=1)

phoneLabel=CTkLabel(leftFrame,text='Phone',font=('arial',18,'bold'))
phoneLabel.grid(row=2,column=0,padx=20,pady=15,sticky='w')

phoneEntry=CTkEntry(leftFrame,font=('arial',15,'bold'),fg_color='white',width=180,text_color='black')
phoneEntry.grid(row=2,column=1)

roleLabel=CTkLabel(leftFrame,text='Role',font=('arial',18,'bold'))
roleLabel.grid(row=3,column=0,padx=20,pady=15,sticky='w')
role_options=['Web Developer','Cloud Architect','Technical Writer','Network Engineer','DevOps Engineer','Data Scientist','Business','IT Consultant','UX/UI Designer']

roleBox=CTkComboBox(leftFrame,values=role_options,width=180,font=('arial',15,'bold'),fg_color='white',state='readonly',text_color='black')
...
genderBox=CTkComboBox(leftFrame,values=gender_options,width=180,font=('arial',15,'bold'),fg_color='white',state='readonly',text_color='black')
...
salaryEntry=CTkEntry(leftFrame,font=('arial',15,'bold'),fg_color='white',width=180,text_color='black')
salaryEntry.grid(row=5,column=1)


rightFrame=CTkFrame(window,fg_color='white')#fcf7f7
rightFrame.grid(row=1,column=1)

search_options=['Id','Name','Phone','Role','Gender','Salary']
searchBox=CTkComboBox(rightFrame,values=search_options,fg_color='white',state='readonly',text_color='black')
